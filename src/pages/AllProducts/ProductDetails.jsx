                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="https://www.whitmorerarebooks.com/pictures/medium/2465.jpg" />
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                <h2 className="text-sm title-font text-title-primary tracking-widest">BRAND NAME</h2>
                                <h1 className="text-title-secondary text-3xl title-font font-medium mb-1">The Catcher in the Rye</h1>
                                ...
                                <div className="flex justify-between">
                                    <span className="title-font font-medium text-2xl md:text-4xl text-title-secondary">$58.00</span>
                                    <button className="btn bg-title-primary text-white rounded-full border-0 h-auto px-8 py-3 font-bold text-base hover:bg-title-secondary">Add to cart</button>
                                </div>
                            </div>
                    </div>
                </div>
